...
//javac -cp .:ENSF380FinalProject/lib/mysql-connector-java-8.0.23.jar ENSF380FinalProject/edu/ucalgary/oop/LoadData.java
//java -cp .:ENSF380FinalProject/lib/mysql-connector-java-8.0.23.jar ENSF380FinalProject.edu.ucalgary.oop.LoadData
        ...
        while (animals.size() > val1) {
            while (tasks.size() > val2){
                if (tasks.get(val2).getDescription().contains("Feeding - " + animals.get(val1).getSpecies())){
                    ...
                    if (!animals.get(val1).getNickname().contains("and")) {
